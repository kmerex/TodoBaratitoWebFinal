<%@ Page Title="" Language="C#" MasterPageFile="~/plantillas/Site1.Master" AutoEventWireup="true" CodeBehind="frmRol.aspx.cs" Inherits="pe.com.todobaratito.ui.frmRol" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <%--inicio de la tarjeta--%>
   <div class="card">
       <div class="card-header text-center">
           <asp:Label ID="Label1" runat="server" Text="MANTENIMIENTO ROL" CssClass="fs-3 fw-bold"></asp:Label>
       </div>
           <div class="card-body">
        <div class="col-3">
        ...
        <div class="table-responsive">
            <asp:GridView ID="gvRol" runat="server" OnRowCommand="gvRol_RowCommand"
                AutoGenerateColumns="false" OnPageIndexChanging="gvRol_PageIndexChanging"
                    ...
                    <asp:Repeater ID="rptPager" runat="server">
                        <ItemTemplate>
                            <asp:LinkButton runat="server" CommandName="Page" CommandArgument="<%# Container.DataItem %>"
                                CssClass='<%# Convert.ToInt32(Container.DataItem.ToString()) == gvRol.PageIndex + 1 ? "btn btn-outline-primary active mx-1" : "btn btn-outline-primary mx-1" %>'>
                    <%# Container.DataItem %>
                            </asp:LinkButton>
                        </ItemTemplate>
                    </asp:Repeater>
