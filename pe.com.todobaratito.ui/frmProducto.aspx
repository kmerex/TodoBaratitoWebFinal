<%@ Page Title="" Language="C#" MasterPageFile="~/plantillas/Site1.Master" AutoEventWireup="true" CodeBehind="frmProducto.aspx.cs" Inherits="pe.com.todobaratito.ui.frmProducto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <%--inicio de la tarjeta--%>
    <div class="card">
        <div class="card-header text-center">
            <asp:Label ID="Label1" runat="server" Text="MANTENIMIENTO PRODUCTO" CssClass="fs-3 fw-bold"></asp:Label>
        </div>
        <div class="card-body">
            <div class="col-3">
            ...
            <div class="col-6">
                <asp:Label ID="Label5" runat="server" Text="Descripcion:" CssClass="form-label"></asp:Label>
                <asp:TextBox ID="txtDes" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
            </div>
            <div class="col-5">
                <asp:Label ID="Label6" runat="server" Text="Precio:" CssClass="form-label"></asp:Label>
                <asp:TextBox ID="txtPre" runat="server" CssClass="form-control" TextMode="Number"></asp:TextBox>
            </div>
            <div class="col-5">
                <asp:Label ID="Label7" runat="server" Text="Cantidad:" CssClass="form-label"></asp:Label>
                <asp:TextBox ID="txtCan" runat="server" CssClass="form-control" TextMode="Number"></asp:TextBox>
            </div>
            <div class="col-4">
                <asp:Label ID="Label8" runat="server" Text="Marca:" CssClass="form-label"></asp:Label>
                <asp:DropDownList ID="cboMarca" runat="server" CssClass="form-select"></asp:DropDownList>
            </div>

            <div class="col-4">
                <asp:Label ID="Label9" runat="server" Text="Categoria" CssClass="form-label"></asp:Label>
            ...
            <div class="table-responsive">
                <asp:GridView ID="gvProducto" runat="server" OnRowCommand="gvProducto_RowCommand"
                    AutoGenerateColumns="false" OnPageIndexChanging="gvProducto_PageIndexChanging"
                        ...
                        <asp:Repeater ID="rptPager" runat="server">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" CommandName="Page" CommandArgument="<%# Container.DataItem %>"
                                    CssClass='<%# Convert.ToInt32(Container.DataItem.ToString()) == gvProducto.PageIndex + 1 ? "btn btn-outline-primary active mx-1" : "btn btn-outline-primary mx-1" %>'>
                        <%# Container.DataItem %>
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:Repeater>
