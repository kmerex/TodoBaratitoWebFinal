<%@ Page Title="" Language="C#" MasterPageFile="~/plantillas/Site1.Master" AutoEventWireup="true" CodeBehind="frmTipoDocumento.aspx.cs" Inherits="pe.com.todobaratito.ui.frmTipoDocumento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <%--inicio de la tarjeta--%>
   <div class="card">
       <div class="card-header text-center">
           <asp:Label ID="Label1" runat="server" Text="MANTENIMIENTO TIPO DOCUMENTO" CssClass="fs-3 fw-bold"></asp:Label>
       </div>
           <div class="card-body">
        <div class="col-3">
        ...
        <div class="table-responsive">
            <asp:GridView ID="gvTipoDocumento" runat="server" OnRowCommand="gvTipoDocumento_RowCommand"
                AutoGenerateColumns="false" OnPageIndexChanging="gvTipoDocumento_PageIndexChanging"
                    ...
                    <asp:Repeater ID="rptPager" runat="server">
                        <ItemTemplate>
                            <asp:LinkButton runat="server" CommandName="Page" CommandArgument="<%# Container.DataItem %>"
                                CssClass='<%# Convert.ToInt32(Container.DataItem.ToString()) == gvTipoDocumento.PageIndex + 1 ? "btn btn-outline-primary active mx-1" : "btn btn-outline-primary mx-1" %>'>
                    <%# Container.DataItem %>
                            </asp:LinkButton>
                        </ItemTemplate>
                    </asp:Repeater>
